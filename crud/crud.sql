...
INSERT INTO `city` VALUES (1,'Zaragoza'),(2,'Barcelona'),(3,'Madrid'),(4,'Bilbao'),(5,'Badajoz'),(7,'Sevilla'),(8,'Santiago'),(9,'Vigo'),(10,'Huesca');
...
CREATE TABLE `language` (
  ...
  `languagecol` varchar(255) NOT NULL,
...
INSERT INTO `pet` VALUES (1,'Gato'),(2,'Perro'),(3,'cocodrilo');
...
INSERT INTO `user` VALUES ('uuid1','a','a@a.com','1234','a.jpg','aaad','2015-11-21 00:00:00',1,1),('uuid2','b','b@b.com','1234','b.jpg','bbbd','2015-10-10 00:00:00',1,2),('uuid3','c','c@c.com','1234','c.jpg','cccd','2015-11-11 00:00:00',2,2);
...
INSERT INTO `user_has_language` VALUES ('uuid1',1),('uuid2',1),('uuid3',1),('uuid1',2),('uuid3',2);
...
INSERT INTO `user_has_pet` VALUES ('uuid1',1),('uuid3',1),('uuid1',2),('uuid2',2),('uuid3',3);
...
-- Dump completed on 2015-11-25 13:04:42
